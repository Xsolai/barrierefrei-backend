...
# Zentrales WCAG Scoring- und Compliance-Schema
WCAG_SCORING_RULES = {
    "score_ranges": {
        "85-100": "Ausgezeichnet (selten - nur bei nahezu perfekter Umsetzung)",
        "70-84": "Gut (solide Umsetzung mit kleineren Verbesserungen nötig)",
        "55-69": "Befriedigend (grundlegende Umsetzung, wichtige Verbesserungen nötig)",
        "40-54": "Ausreichend (teilweise Umsetzung, erhebliche Probleme vorhanden)",
        "25-39": "Mangelhaft (große Probleme, aber Grundlagen erkennbar)",
        "0-24": "Ungenügend (kritische Barrieren, grundlegende Überarbeitung nötig)"
    },
    "compliance_mapping": {
        "AAA (90-100)": "Exzellente Barrierefreiheit - übertrifft Standards deutlich",
        "AA (80-89)": "Gute Barrierefreiheit - erfüllt wichtige Standards",
        "A (65-79)": "Grundlegende Barrierefreiheit - Basis-Standards erfüllt",
        "PARTIAL (40-64)": "Teilweise barrierefrei - wichtige Lücken vorhanden",
        "NONE (0-39)": "Nicht barrierefrei - umfassende Überarbeitung nötig"
    },
    "philosophy": "Seien Sie AUSGEWOGEN - erkennen Sie vorhandene gute Implementierungen an UND identifizieren Sie Verbesserungen. Fokussieren Sie auf WIRKUNGSVOLLE Verbesserungen statt Perfektion. Ein Score zwischen 40-80 ist für die meisten Websites normal und hilfreich."
}
